...
const Feature = memo(({ feature, index }: { feature: any; index: number }) => (
  <motion.div
...
>
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-orange-500/20 backdrop-blur-sm px-4 py-2 rounded-full mb-6 border-2 border-orange-400/30">
            ...
            <div className="w-32 h-1.5 bg-gradient-to-r from-emerald-400 to-orange-400 mx-auto mt-6 rounded-full" />
          </motion.div>
          ...
          >
            {/* Glowing border */}
            <div className="absolute inset-0 bg-gradient-to-r from-emerald-500 via-orange-500 to-pink-500 rounded-3xl blur-sm" />
            <div className="absolute -inset-1 bg-gradient-to-r from-emerald-500 via-orange-500 to-pink-500 opacity-20 blur-2xl"></div>

            <Card className="relative bg-slate-900/95 backdrop-blur-xl p-10 sm:p-14 shadow-2xl border-2 border-white/10">
              <div className="text-center space-y-8">
                ...
                <div className="bg-white/5 backdrop-blur-md rounded-xl p-8 space-y-6 border border-white/10">
