...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const rateLimitCheck = await checkRateLimit(clientIP, 'contact');
    ...
    const { name, email, phone, subject, message, grade } = body;
    ...
    const sanitizedData = {
      ...
      grade: grade ? sanitizeString(grade) : null,
    ...
    await recordSubmission(clientIP, 'contact');
